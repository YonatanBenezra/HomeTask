      ...
      <CRow>
        <CCol>
          <CCard>
            ...
            <CCardBody>
              <CEmbed>
                <CEmbedItem src="https://www.youtube.com/embed/zlhWFJtPisg" type="video" />
              </CEmbed>
            </CCardBody>
            <CCardHeader style={{ backgroundColor: "var(--info)" }} />
            <CCardBody style={{ padding: "2rem 10rem" }}>
              <h1 style={{ textAlign: "center" }}>What is Pinterest</h1>
              ...
              <hr></hr>
              Pinterest is an Edtech company founded by Lorem Ipsum
            </CCardBody>
