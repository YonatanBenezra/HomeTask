      ...
      <CRow>
        <CCol>
          <CCard>
            ...
            <CCardBody>
              <CEmbed>
                <CEmbedItem src="https://www.youtube.com/embed/QwS1r1mc888" type="video" />
              </CEmbed>
            </CCardBody>
            <CCardHeader style={{ backgroundColor: "var(--info)" }} />
            <CCardBody style={{ padding: "2rem 10rem" }}>
              <h1 style={{ textAlign: "center" }}>What is Stackoverflow</h1>
              ...
              <hr></hr>
              Stackoverflow is an Edtech company founded by Lorem Ipsum
            </CCardBody>
