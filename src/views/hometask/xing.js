      ...
      <CRow>
        <CCol>
          <CCard>
            ...
            <CCardBody>
              <CEmbed>
                <CEmbedItem src="https://www.youtube.com/embed/PmFVM_N7Ggo" type="video" />
              </CEmbed>
            </CCardBody>
            <CCardHeader style={{ backgroundColor: "var(--info)" }} />
            <CCardBody style={{ padding: "2rem 10rem" }}>
              <h1 style={{ textAlign: "center" }}>What is Xing</h1>
              ...
              <hr></hr>
              Xing is an Edtech company founded by Lorem Ipsum
            </CCardBody>
