      ...
      <CRow>
        <CCol>
          <CCard>
            ...
            <CCardBody>
              <CEmbed>
                <CEmbedItem src="https://vimeo.com/blog/post/showcase-new-way-show-off-videos-everywhere/" type="video" />
              </CEmbed>
            </CCardBody>
            <CCardHeader style={{ backgroundColor: "var(--info)" }} />
            <CCardBody style={{ padding: "2rem 10rem" }}>
              <h1 style={{ textAlign: "center" }}>What is Vimeo</h1>
              ...
              <hr></hr>
              Vimeo is an Edtech company founded by Lorem Ipsum
            </CCardBody>
